...
import type { CategoryModel } from '@core/category/infra/db/sequelize/model/category.model';
...
import { CategoryModelMapper } from '@core/category/infra/db/sequelize/mappers/category-model.mapper';
